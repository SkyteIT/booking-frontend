...
import { cancelMyBooking } from "../../services/Customer/bookingService";

export function useCustomerBookingsPage() {
  ...
  const { data, loading, error, page, setPage, pageCount, refetch } = useCustomerBookings({
    initialPageSize: 8,
