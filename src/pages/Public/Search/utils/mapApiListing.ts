...
export function mapApiListing(api: ListingResponse): Listing {
  ...
  return {
    ...
    primaryRoomType: api.hotelDetails?.primaryRoomType,
    ...
    ticketPrice: api.eventDetails?.ticketPrice,
    ...
    hourlyRate: api.carRentalDetails?.hourlyRate,
    ...
    customFieldValues: api.customFieldValues,
    optionGroups: api.optionGroups,
  };
}
